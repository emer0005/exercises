...
function klik(evt) {
  ...
  if (typeOfInput === "num") {
    ...
    if (regneArt === "") {
      ...
      firstNumVal = Number.parseInt(firstNumVal);
      console.log("firstNumVal", Number.parseInt(firstNumVal));
    } else {
      secondNumVal += btnClicked;
      secondNumVal = Number.parseInt(secondNumVal);
      console.log("secondNumVal", secondNumVal);
    }
  } else if (typeOfInput === "regneart") {
    // hvis det er en regneart, så gem den
    regneArt = btnClicked;
    console.log("regneart", btnClicked);
    ...
    if (regneArt === "+") {
      displayContent = firstNumVal + secondNumVal;
      console.log("resultat", displayContent);
    } else if (regneArt === "-") {
      displayContent = firstNumVal - secondNumVal;
      console.log("resultat", displayContent);
    } else if (regneArt === "*") {
